...
#programmers = [Student(x[0]) for x in student_tups_list]
programmers = [Student(x[0],x[1],x[2]) for x in student_tups_list]

print (programmers)

# for x in student_tups_list:
#     print (Student(x[0], x[1], x[2]))

# print (type(programmers[1]))
# print (type(programmers[0]))
# print (programmers)

#print ([x.name for x in programmers])
...
# Use the Python map function on the programmers list you just created, in order to create a map instance iterator of numbers representing the 
# productivity of each student. Save the map iterator in a variable called prod_iter.
...
# z = [x for x in programmers]
# print (z)
# programming_productivity = []
# names_x = []

# for x in programmers:
#     productivity = (x.num_programs)/(x.years_UM)
#     programming_productivity.append(productivity)
#     names_x.append(x.name)

# print(programming_productivity)
# print (names_x)
...
# print (Student(x).program_productivity for x in programmers)
# programming_productivity = map(Student().program_productivity(), programmers.name, programmers.years_UM, programmers.num_programs)

# prod_iter = map(Student)
# prod_list = list(prod_iter)

#programming_productivity = Student().num_programs/Student().years_UM


#prod_iter = map(programmers, programming_productivity)
...
for x in programmers:
    productivity = float(x.num_programs)/float(x.years_UM)
    programming_productivity.append(productivity)
    names_x.append(x.name)


#for x in programmers:
names_and_productivities = (zip(names_x, programming_productivity))
#print (zip(names_x, programming_productivity))
...
def readfiles(file_list):
    ...
    for x in file_list:
        ...
        b = v.readlines()
        #print (b)
        if len(lst_lines) is 0:
            lst_lines.append(b)
        else:
            lst_lines[0] = lst_lines[0] + b
    #print (lst_lines)
    #print (len(lst_lines[0]))
